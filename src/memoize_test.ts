...
Deno.test("simple memoization with primitive arg", () => {
  let numTimesCalled = 0;
...
Deno.test("memoization with ...spread primitive args", () => {
  let numTimesCalled = 0;
...
Deno.test("`this` binding is preserved`", () => {
  class X {
...
Deno.test("should use `this` binding of function for `getKey`", () => {
...
Deno.test("reference arg with default caching", () => {
  let numTimesCalled = 0;
...
Deno.test("multiple reference args with default caching", () => {
  let numTimesCalled = 0;
...
Deno.test("non-primitive arg with `getKey`", () => {
  let numTimesCalled = 0;
...
Deno.test("primitive arg with `getKey`", () => {
  let numTimesCalled = 0;
...
Deno.test("works with async functions", async () => {
...
Deno.test("passing a `Map` as a cache", () => {
  let numTimesCalled = 0;
  const cache = new Map();
  const fn = memoize((n: number) => {
    ++numTimesCalled;
...
Deno.test("passing a custom cache object", () => {
  let numTimesCalled = 0;
...
Deno.test("only cache single latest result", () => {
  let numTimesCalled = 0;
...
Deno.test("introspecting the cache", () => {
...
Deno.test("on-the-fly memoization", () => {
  let numTimesCalled = 0;
